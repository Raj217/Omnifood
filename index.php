...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/querries.css">
    ...
    <body>
        <header id='welcome'>
            <nav>
                <div class='row'>
                    <img src="resources/img/logo-white.png" alt="Omnifodd Logo" class="logo">
        ...
        <section class="section-features js--section-features" id='features'>
            ...
            <div class="row js--wp-1">
                <div class="col span-1-of-4 box">
                    <i class="ion-ios-infinite icon-large"></i>
                ...
                <div class="col span-1-of-4 box">
                    <i class="ion-android-stopwatch icon-large"></i>
                ...
                <div class="col span-1-of-4 box">
                    <i class="ion-ios-nutrition icon-large"></i>
                    <h3>100% organic</h3>
                    <p>
                ...
                <div class="col span-1-of-4 box">
                    <i class="ion-android-cart icon-large"></i>
        ...
        <section class="section-steps" id="works">
            ...
            <div class="row">
                <div class="col span-1-of-2 app-img">
            ...
            <div class="row js--wp-3">
                <div class="col span-1-of-4 box">
                    ...
                    <div class="city-features">
                        ...
                        <a href="#" class="link">@omnifood_lx</a>
                    </div>
                </div>
                <div class="col span-1-of-4 box">
                    ...
                    <div class="city-features">
                        <i class="ion-social-twitter icon-small"></i>
                        <a href="#" class="link">@omnifood_sf</a>
                    </div>
                </div>
                <div class="col span-1-of-4 box">
                    ...
                    <div class="city-features">
                        <i class="ion-social-twitter icon-small"></i>
                        <a href="#" class="link">@omnifood_berlin</a>
                    </div>
                </div>
                <div class="col span-1-of-4 box">
                    ...
                    <div class="city-features">
                        <i class="ion-social-twitter icon-small"></i>
                        <a href="#" class="link">@omnifood_london</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section-testimonials">
            ...
            <div class="row">
                <div class="col span-1-of-3">
                    ...
                    <cite><img src="resources/img/customer-1.jpg " alt="Alberto Duncan photo">Alberto Duncan</cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                        Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon, but no one comes even close to Omifood. Me and my family are so in love!
                    <cite><img src="resources/img/customer-2.jpg" alt="Joana Silva photo">Joana Silva</cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                        I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
                    <cite><img src="resources/img/customer-3.jpg" alt="Milton Chapman photo">Milton Chapman</cite>
                    </blockquote>
                </div>
            </div>
            ...
            <div class="name">
                <form method="post" action="resources/php/mailer.php" class="contact-form">
                    <div class="row">
                        ...
                        <?php
                        if ($_GET['success'] == 1) {
                            echo "<div class=\"form-message success\">Thank You! Your message has been sent sucessfully.</div>";
